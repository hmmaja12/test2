...
<body>
    ...
    <div class="container mt-4">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card mb-4">
                    <img src="/image/123.PNG" class="card-img-top" alt="Gambar Berita 1">
                    <div class="card-body">
            ...
            <div class="col-md-12">
                <div class="card mb-4">
                    <img src="/image/321.PNG" class="card-img-top" alt="Gambar Berita 2">
                    <div class="card-body">
                        <h5 class="card-title">SPMI Jurusan Teknik Informatika</h5>
                        <p class="card-text">Dalam Proses Upgrading Program Studi Diploma Tiga Teknik Informatika Menjadi Sarjana Terapan Teknologi Rekayasa Komputer Jurusan Teknik Informatika Politeknik Negeri  Bengkalis,.</p>
                        <a href="#" class="btn btn-primary">Baca Selengkapnya</a>
                    </div>
                </div>
            </div>
