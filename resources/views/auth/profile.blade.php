...
<body>
    ...
    <div class="container mt-4">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card mb-4">
                    <img src="/image/puad.jpeg" class="card-img-top" alt="Foto Lulusan 1">
                    <div class="card-body">
                        <h5 class="card-title">Anwar Puadi Lubis</h5>
            ...
            <div class="col-md-6">
                <div class="card mb-4">
                    <img src="/image/kiw.jpeg" class="card-img-top" alt="Foto Lulusan 2">
                    <div class="card-body">
                        <h5 class="card-title">Daffa Alfa Rizi</h5>
